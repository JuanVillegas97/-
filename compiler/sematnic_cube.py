...
class SemanticCube:
    def __init__(self):
        self.__cube = {
            ...
            (INT, STRING):     [ERROR, ERROR, ERROR, ERROR, ERROR, ERROR  ,  ERROR  ],
            ...
            (FLOAT, STRING):   [ERROR, ERROR, ERROR, ERROR, ERROR, ERROR  ,  ERROR  ],
            ...
            (CHAR, STRING):    [ERROR, ERROR, ERROR, ERROR, ERROR, ERROR  ,  ERROR  ],
            (BOOLEAN, BOOLEAN):[ERROR , ERROR, ERROR, ERROR, ERROR, BOOLEAN,  BOOLEAN],
            (STRING, STRING):  [ERROR, ERROR, ERROR, ERROR, ERROR, ERROR  ,  STRING  ],
