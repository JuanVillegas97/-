...
_lr_productions = [
  ...
  ('program -> PROGRAM ID SEMICOLON var_declarations functions MAIN LPAREN RPAREN var_declarations LBRACE statements RBRACE END','program',13,'p_program','grammar.py',7),
  ('var_declarations -> var_declarations var_declaration','var_declarations',2,'p_var_declarations','grammar.py',13),
  ('var_declarations -> var_declaration','var_declarations',1,'p_var_declarations','grammar.py',14),
  ('var_declarations -> empty','var_declarations',1,'p_var_declarations','grammar.py',15),
  ('var_declaration -> VARIABLE simple_type variables SEMICOLON','var_declaration',4,'p_var_declaration','grammar.py',20),
  ('variables -> variables COMMA variable','variables',3,'p_variables','grammar.py',27),
  ('variables -> variable','variables',1,'p_variables','grammar.py',28),
  ('variable -> ID','variable',1,'p_variable','grammar.py',34),
  ('variable -> ID LBRACK expression RBRACK','variable',4,'p_variable','grammar.py',35),
  ('variable -> ID LBRACK expression RBRACK LBRACK expression RBRACK','variable',7,'p_variable','grammar.py',36),
  ...
  ('function -> FUNCTION simple_type ID LPAREN parameters RPAREN var_declarations LBRACE statements statement RBRACE','function',11,'p_function','grammar.py',49),
  ('function -> FUNCTION VOID ID LPAREN parameters RPAREN var_declarations LBRACE statements RBRACE','function',10,'p_function','grammar.py',50),
  ('parameters -> parameters COMMA parameter','parameters',3,'p_parameters','grammar.py',75),
  ('parameters -> parameter','parameters',1,'p_parameters','grammar.py',76),
  ('parameters -> empty','parameters',1,'p_parameters','grammar.py',77),
  ('parameter -> simple_type ID','parameter',2,'p_parameter','grammar.py',82),
  ('statements -> statements statement','statements',2,'p_statements','grammar.py',87),
  ('statements -> statement','statements',1,'p_statements','grammar.py',88),
  ('statements -> empty','statements',1,'p_statements','grammar.py',89),
  ('statement -> assingation','statement',1,'p_statement','grammar.py',94),
  ('statement -> invocation','statement',1,'p_statement','grammar.py',95),
  ('statement -> if','statement',1,'p_statement','grammar.py',96),
  ('statement -> read','statement',1,'p_statement','grammar.py',97),
  ('statement -> return','statement',1,'p_statement','grammar.py',98),
  ('statement -> print','statement',1,'p_statement','grammar.py',99),
  ('print -> PRINT LPAREN expression RPAREN SEMICOLON','print',5,'p_print','grammar.py',104),
  ('print -> PRINT LPAREN CTES RPAREN SEMICOLON','print',5,'p_print','grammar.py',105),
  ('if -> IF LPAREN expression RPAREN LBRACE statements RBRACE','if',7,'p_if','grammar.py',110),
  ('if -> IF LPAREN expression RPAREN LBRACE statements RBRACE ELSE LBRACE statements RBRACE','if',11,'p_if','grammar.py',111),
  ('return -> RETURN expression SEMICOLON','return',3,'p_return','grammar.py',118),
  ('read -> READ LPAREN variable RPAREN SEMICOLON','read',5,'p_read','grammar.py',123),
  ('assingation -> variable ASSIGN expression SEMICOLON','assingation',4,'p_assingation','grammar.py',128),
  ('invocation -> ID LPAREN expressions RPAREN SEMICOLON','invocation',5,'p_invocation','grammar.py',134),
  ('expressions -> expressions COMMA expression','expressions',3,'p_expressions','grammar.py',139),
  ('expressions -> expression','expressions',1,'p_expressions','grammar.py',140),
  ('expressions -> empty','expressions',1,'p_expressions','grammar.py',141),
  ('expression -> t_expression','expression',1,'p_expression','grammar.py',146),
  ('expression -> t_expression ASSIGN t_expression','expression',3,'p_expression','grammar.py',147),
  ('t_expression -> g_expression','t_expression',1,'p_t_expression','grammar.py',152),
  ('t_expression -> g_expression boolean_operator g_expression','t_expression',3,'p_t_expression','grammar.py',153),
  ('g_expression -> m_expression','g_expression',1,'p_g_expression','grammar.py',158),
  ('g_expression -> m_expression comparison_operator m_expression','g_expression',3,'p_g_expression','grammar.py',159),
  ('m_expression -> term','m_expression',1,'p_m_expression','grammar.py',164),
  ('m_expression -> term addition_operator term','m_expression',3,'p_m_expression','grammar.py',165),
  ('term -> factor','term',1,'p_term','grammar.py',170),
  ('term -> factor multiplication_operator factor','term',3,'p_term','grammar.py',171),
  ('factor -> variable','factor',1,'p_factor','grammar.py',176),
  ('factor -> cte','factor',1,'p_factor','grammar.py',177),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor','grammar.py',178),
  ('factor -> invocation','factor',1,'p_factor','grammar.py',179),
  ('comparison_operator -> LESS','comparison_operator',1,'p_comparison_operator','grammar.py',184),
  ('comparison_operator -> GREATER','comparison_operator',1,'p_comparison_operator','grammar.py',185),
  ('comparison_operator -> EQUALS','comparison_operator',1,'p_comparison_operator','grammar.py',186),
  ('comparison_operator -> NOTEQUAL','comparison_operator',1,'p_comparison_operator','grammar.py',187),
  ('addition_operator -> PLUS','addition_operator',1,'p_addition_operator','grammar.py',192),
  ('addition_operator -> MINUS','addition_operator',1,'p_addition_operator','grammar.py',193),
  ('boolean_operator -> AND','boolean_operator',1,'p_boolean_operator','grammar.py',198),
  ('boolean_operator -> OR','boolean_operator',1,'p_boolean_operator','grammar.py',199),
  ('multiplication_operator -> TIMES','multiplication_operator',1,'p_multiplication_operator','grammar.py',204),
  ('multiplication_operator -> DIVIDE','multiplication_operator',1,'p_multiplication_operator','grammar.py',205),
  ('simple_type -> INT','simple_type',1,'p_simple_type','grammar.py',210),
  ('simple_type -> FLOAT','simple_type',1,'p_simple_type','grammar.py',211),
  ('simple_type -> CHAR','simple_type',1,'p_simple_type','grammar.py',212),
  ('simple_type -> STRING','simple_type',1,'p_simple_type','grammar.py',213),
  ('simple_type -> BOOLEAN','simple_type',1,'p_simple_type','grammar.py',214),
  ('cte -> CTEI','cte',1,'p_cte','grammar.py',222),
  ('cte -> CTEF','cte',1,'p_cte','grammar.py',223),
  ('cte -> CTEC','cte',1,'p_cte','grammar.py',224),
  ('cte -> CTES','cte',1,'p_cte','grammar.py',225),
  ('cte -> CTEB','cte',1,'p_cte','grammar.py',226),
